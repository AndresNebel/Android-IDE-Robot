...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Rows: %1</span><span id="Plane_getRows">रांगा (%1)</span><span id="Plane_rows1">प्रथम श्रेणीच्या ओळी: %1</span><span id="Plane_getRows1">1st class rows (%1)</span><span id="Plane_rows2">2nd class rows: %1</span><span id="Plane_getRows2">दुसऱ्या वर्गाची रांग(%1)</span><span id="Plane_seats">Seats: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">आसने =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html">Blockly</a> : विमान</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'विमानात,प्रवाश्यांसाठी आसनांच्या अनेक रांगा असतात.प्रत्येक रांगेत चार आसने असतात.';
      break;
    case 2:
      output += 'विमानास, विमानन कक्षात दोन आसने असतात(वैमानिक व सह-वैमानिकासाठी) व प्रवाश्यांसाठी आसनांच्या अनेक रांगा असतात.प्रत्येक रांगेत चार आसने असतात.';
      break;
    case 3:
      output += 'विमानास, विमानन कक्षात दोन आसने असतात(वैमानिक व सह-वैमानिकासाठी) व प्रथम श्रेणी व द्वितीय श्रेणी आसनांच्या अनेक रांगा असतात.प्रत्येक प्रथम श्रेणीच्या रांगेत चार आसने असतात.प्रत्येक द्वितीय श्रेणीच्या रांगेत पाच आसने असतात.';
      break;
  }
