...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">الصفوف: 1%</span><span id="Plane_getRows">الصفوف (1%)</span><span id="Plane_rows1">صفوف الطبقة الأولى: 1%</span><span id="Plane_getRows1">صفوف الطبقة الأولى (1%)</span><span id="Plane_rows2">صفوف الفئة الثانية: 1%</span><span id="Plane_getRows2">صفوف الفئة الثانية: (1%)</span><span id="Plane_seats">المقاعد: 1%</span><span id="Plane_placeholder">؟</span><span id="Plane_setSeats">المقاعد =</span></div>';
};
