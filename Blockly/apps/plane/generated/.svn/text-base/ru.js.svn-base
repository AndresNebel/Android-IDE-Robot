...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Рядов: %1</span><span id="Plane_getRows">ряды (%1)</span><span id="Plane_rows1">Рядов 1-го класса: %1</span><span id="Plane_getRows1">ряды 1-го класса (%1)</span><span id="Plane_rows2">Рядов 2-го класса: %1</span><span id="Plane_getRows2">ряды 2-го класса (%1)</span><span id="Plane_seats">Мест: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">места =</span></div>';
};
