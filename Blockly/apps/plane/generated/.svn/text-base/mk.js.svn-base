...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Редови: %1</span><span id="Plane_getRows">редови (%1)</span><span id="Plane_rows1">Редови од I класа: %1</span><span id="Plane_getRows1">Редови од I класа (%1)</span><span id="Plane_rows2">Редови од II класа: %1</span><span id="Plane_getRows2">Редови од II класа: (%1)</span><span id="Plane_seats">Седишта: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">места =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html">Блокли</a> : Авион</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Авионот има извесен број редови од седишта. Секој ред има по четири седишта.';
      break;
    case 2:
      output += 'Авионот има две седишта во пилотската кабина (за пилотот и копилотот) и повеќе редови седишта за патници. Секој ред има по четири седишта.';
      break;
    case 3:
