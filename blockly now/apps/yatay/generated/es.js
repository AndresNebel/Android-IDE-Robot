...
codepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script>' +
  // '<script type="text/javascript" src="../yatay/yatay/lib/jquery-2.0.3.min.js"></script>' +
  // '<script type="text/javascript" src="../yatay/yatay/lib/yepnope.1.5.4-min.js"></script>' +
  // '<script type="text/javascript" src="../yatay/yatay/lib/modernizr-2.5.3.min.js"></script>' +
  // '<link href="../yatay/yatay/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">' +
  // '<script type="text/javascript">Modernizr.load({' +
				// "test: Modernizr.mq('only all and (max-device-width:480px)')," +
				// 'yep: ["../yatay/yatay/js/common.js",'+ '"../yatay/yatay/js/mobile.js",' +  '"../yatay/yatay/css/mobile.css"],' +
				// 'nope: ["../yatay/yatay/js/common.js",'+ '"../yatay/yatay/js/tablet.js",' + '"../yatay/yatay/css/tablet.css"]'+
			// '});</script>' +
  '<script type="text/javascript" src="yatay/lib/bootstrap/js/bootstrap.min.js"></script>' +
  '<table id="svg"><tr><td><h1 style="display:none"><span id="title"><a href="../index.html">Blockly</a> : Codigo</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td colspan=2><table width="100%"><tr id="tabRow" height="1em"><td id="tab_blocks" class="tabon" onclick="Code.tabClick(this.id)" style="display:none">Bloques</td><td class="tabmax"></td></tr></table></td></tr><tr><td height="99%" colspan=2 id="content_area">' + codepage.toolbox(null, null, opt_ijData) + '</td></tr></table><div id="content_blocks" class="content"></div><textarea id="content_xml" class="content" wrap="off"></textarea>' + apps.dialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData);
};
